  ...
  return (
    <>
      <div className="container500">
        <div className="left-side500">
          <p className="text-7xl500">500</p>
          <p className="text-4xl500">Server Error</p>
          <p className="text-lg500">
            Whoops, something went wrong on our servers.
          </p>
          <p className="text-sm500">
            Please try again in a few moments or contact us if the problem
          </p>
        </div>
        <div className="right-side500">
          <svg
            className="full500"
